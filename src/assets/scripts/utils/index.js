...
export const getClosestElementByClass = (element, className, rootElememt = document) => {
...
export const getClosestElementByAttribute = (element, attribute, rootElememt = document) => {
  if (element === rootElememt) return null;
